...
const generateQRCodeText = (app) => {
  return `It is to certify that ${app.name.toUpperCase()},father name: ${app.fatherName.toUpperCase()},mother name: ${app.motherName.toUpperCase()}.He/She has been passed ${app.lastExamName.toUpperCase()} on ${
    app.passingYear
  }. He/Shebearing roll: ${app.roll},registration: ${
    app.registration
  }.He/She has gained ${app.result} ${renderResultType(
    app.resultType
  )} on ${renderGroup(
    app.group
  )}group/subject/trade.I wish your life best. This document is generated by Jibannagar Degree College. You may verify.`;
};
                ...
                <Box sx={{ display: "flex", flexDirection: "column" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      {renderGenderText(application.gender)}
